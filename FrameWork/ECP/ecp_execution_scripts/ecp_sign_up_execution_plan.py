...
from FrameWork.ECP.ecp_execution_scripts.ecp_exectue_test_cases import ECPExecuteTestCases
from FrameWork.pkg_utilities.utility_script_general import UtilityPackage


class ecpExecutionPlanExcelRead(FrameWorkBaseDriver):
    ...
    def test_execution_plan_read_excel(self, excel_path_location):
        ...
        peza_call_test_cases = ECPExecuteTestCases(self.driver)
