...
from FrameWork.peza.peza_execute_test_cases.ip_execute_test_cases import ImportPermitExecuteTestCases
from FrameWork.pkg_utilities.utility_script_general import UtilityPackage


class ImporterPermitExecutionPlanExcelRead(FrameWorkBaseDriver):
    ...
    def test_execution_plan_read_excel(self, excel_path_location):
        ...
        peza_call_test_cases = ImportPermitExecuteTestCases(self.driver)
