...
from FrameWork.peza.peza_execute_test_cases.signup_execute_test_cases import ExecuteSignUpTestCases
from FrameWork.pkg_utilities.utility_script_general import UtilityPackage


class SignUpExecutionPlanExcelRead(FrameWorkBaseDriver):
    ...
    def test_execution_plan_read_excel(self, excel_path_location):
        ...
        peza_call_test_cases = ExecuteSignUpTestCases(self.driver)
