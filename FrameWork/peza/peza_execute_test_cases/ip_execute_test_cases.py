...
from FrameWork.peza.import_permit.import_permit_ent_pages import ImportPermitElementLocations

class ImportPermitExecuteTestCases(FrameWorkBaseDriver):
    ...
    def peza_import_permit_ent_pages(self):
        return ImportPermitElementLocations(self.driver)
    ...
    def peza_main_dictionary(self, get_element):
        get_peza_main_module = {
            ...
            "peza_create_new_import_permit": 'self.peza_import_permit_ent_pages()'
        }
        ...
        get_peza_main_function = {
            ...
            "peza_create_new_import_permit": 'get_create_new_import_permit'
        }
        ...
        get_peza_main_function_other = {
            ...
            "get_create_new_import_permit": 'get_create_new_import_permit_others'
        }
